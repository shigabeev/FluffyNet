...
# Credits to: https://www.kaggle.com/iafoss
# Original solution: https://www.kaggle.com/iafoss/unet34-dice-0-87/notebook
...
get_ipython().run_line_magic('pinfo', 'ImageData')
