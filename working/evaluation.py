...
# and "Unet34 (dice 0.87+)"
# (https://www.kaggle.com/iafoss/unet34-dice-0-87/notebook)
# that shows how to evaluate the solution and submit predictions.
# Please check these notebooks for additional details.
